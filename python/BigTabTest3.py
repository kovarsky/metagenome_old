...
def read_all_files(index_handler, filename_list, logf, chrom_set, path,tresholds, max_alt_treshold,sum_alt_treshold, suffix):
...
def main(index_handler, filename_list_handler, chrom_list_handler, max_alt_treshold, sum_alt_treshold, suffix, tresholds):
    ...
    read_all_files(index_handler, filename_list, logf, chrom_set, path,tresholds, max_alt_treshold,sum_alt_treshold, suffix)
